            ...
            <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 product-content">
                <div class="product-wrap">
                    <div class="collection__title">
                        <?php
                            echo '<h3>Sau đây là các linh kiện mà EStore gợi ý cho bạn với mức giá: <span style="color: red;">'.$price.' VNĐ</span></h3>';
                        ?>
                        <style>
                            .suggestions:hover {color: red;}
                        </style>
                        <div class="collection-filter" id = "list-product">
                            <div class="category-products clearfix">
                                <div class="products-grid clearfix">
                                    <?php if($price < $min_price): ?>
                                        <div style="margin: 15px 0 0 20px;">
                                            <span style="font-size: 2rem;">
                                                EStore rất tiếc,<br/>
                                                Giá linh kiện cho 1 chiếc PC tự build tại EStore thấp nhất là: 
                                                <span style="font-weight: bold; color: red;"><?= $min_price; ?> VNĐ</span>
                                            </span>
                                        </div>
                                    <?php else : ?>
                                        <?php foreach($list as $sp) : $sp = $sp[0];?>
